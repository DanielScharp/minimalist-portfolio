...
import { HardSkillsSection } from "./hard-skills-section"
...
export function AboutSection({ data = aboutData }: AboutSectionProps) {
  return (
    <div className="space-y-8 md:space-y-10">
      {/* About Me */}
      <div>
        <h2 className="text-2xl md:text-3xl font-bold text-foreground mb-4">Sobre mim</h2>
      ...
      {/* What I'm Doing */}
      <div>
        <h3 className="text-xl md:text-2xl font-bold text-foreground mb-6">O Que Estou Fazendo</h3>
      ...
      {/* Hard Skills Section */}
      <HardSkillsSection skills={data.hardSkills} />

      <div>
        <h3 className="text-xl md:text-2xl font-bold text-foreground mb-6">Depoimentos</h3>
        <DraggableMarquee speed={50} gap="gap-3 md:gap-4">
      ...
      {/* <div>
        <h3 className="text-xl md:text-2xl font-bold text-foreground mb-6">Clientes</h3>
        <DraggableMarquee speed={35} gap="gap-4 md:gap-6" className="py-4">
